            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center p-4">
                    ...
                    <div class="btns-table d-flex gap-2">
                        <button wire:click="resetData()" data-toggle="modal" data-target="#create" type="button" class="btn-hover btn-sm btn-border-radius color-5">ایجاد مقاله</button>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-create">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">{{$this->editMode ? 'ویرایش  مقاله' : 'ساخت  مقاله'}}</h5>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="slug">آدرس  مقاله</label>
                        ...
                        <div class="form-group">
                            <label for="slug">خلاصه مقاله</label>
                            <textarea id="description" wire:model.lazy="description" rows="3"  placeholder="خلاصه  مقاله را وارد کنید"></textarea>
                            @error('description')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="content">توضیحات  مقاله</label>
                            <div wire:ignore>
                                <div id="content"></div>
                            </div>
                            @error('content')

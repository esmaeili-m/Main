<div>
    ...
    @section('breadcrumb')
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Article</h1>
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        <button wire:click="resetData()" data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo8" class="btn btn-sm btn-success-light">Create New Article<i class="ri-plus ms-2 d-inline-block align-middle"></i></button>
        ...
        <div class="modal-dialog modal-dialog-centered text-center  modal-xl" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{$this->editMode ? 'Update Article' : 'Create Article'}}</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body text-start">
                    <form>
                        <div class="row">
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mb-3">
                                <p class="mb-2 text-muted">Article Title</p>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                                <p class="mb-2 text-muted">Article Slug</p>
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mb-3">
                                <label for="input-file" class="form-label">Description Article</label>
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mb-3">
                                <div wire:ignore>
                                    <label for="input-file" class="form-label">Content Article</label>

            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        <button wire:click="resetData()" data-bs-effect="effect-flip-vertical" data-bs-toggle="modal" href="#modaldemo8" class="btn btn-sm btn-success-light">Create New Faq<i class="ri-plus ms-2 d-inline-block align-middle"></i></button>
        ...
        <div class="modal-dialog modal-dialog-centered text-center  modal-xl" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{$this->editMode ? 'Update Faq' : 'Create Faq'}}</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body text-start">
                    <form>
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                                <p class="mb-2 text-muted">Faq Title</p>
                                <input id="question" wire:model.lazy="question" type="text" class="form-control" placeholder="Enter Question">
                                @error('question')
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mb-3">
                                <div wire:ignore>
                                    <label for="input-file" class="form-label">Description Faq</label>
    ...
    @section('scripts')
        ...
        <script>
            document.addEventListener("livewire:initialized", () => {
                ...
                quill.root.innerHTML = @this.get('answer') || '';
                quill.on('text-change', function () {
                    const html = quill.root.innerHTML;
                @this.set('answer', html);
                });
                ...
                @this.set('answer', quill.root.innerHTML);
                });
                ...
                Livewire.on("update_item", () => {
                    if (quill) {
                        quill.clipboard.dangerouslyPasteHTML(@this.get('answer'));
